...
class PolymarketV2Engine {
  ...
  async executePurePolymarketCycle() {
    ...
    if (approved.length > 0) {
      ...
      const legs = await this.alphaEngine.executeBracketArbitrage(best.bracket, effectiveLegSize);
      ...
      return { verdict: 'EXECUTED', bracket: best.bracket.title, legs, legSize: effectiveLegSize };
    }
